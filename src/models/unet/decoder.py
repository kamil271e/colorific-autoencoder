...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, upsample_factor, dropout_rate):
...
class Decoder(nn.Module):
    def __init__(self, out_channels, unit, dropout_rate):
        super(Decoder, self).__init__()
        print("DROPOUT", dropout_rate)
        self.dec0 = DecoderBlock(16 * unit, 8 * unit, 2, dropout_rate)
        self.dec1 = DecoderBlock(8 * unit, 4 * unit, 2, dropout_rate)
        self.dec2 = DecoderBlock(4 * unit, 2 * unit, 2, dropout_rate)
        self.dec3 = DecoderBlock(2 * unit, unit, 2, dropout_rate)
